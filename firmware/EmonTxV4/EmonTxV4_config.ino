...
static void list_calibration(void)
{
  ...
  Serial.print(F("i5Cal = ")); Serial.println(EEProm.i5Cal);
  Serial.print(F("i5Lead = ")); Serial.println(EEProm.i5Lead);
  Serial.print(F("i6Cal = ")); Serial.println(EEProm.i6Cal);
  Serial.print(F("i6Lead = ")); Serial.println(EEProm.i6Lead);
